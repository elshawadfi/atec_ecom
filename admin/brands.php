...
$db = getDbInstance();
$select = array('id', 'name', 'image' ,'category_id');
...
$rows = $db->arraybuilder()->paginate('brand', $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_brand.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
...
foreach ($category as $value) {
  if($value['id'] == $row['category_id']){
    ...
    <div class="text-center">
    	<?php echo paginationLinks($page, $total_pages, 'brands.php'); ?>
    </div>
    <!-- //Pagination -->
</div>
<!-- //Main container -->
